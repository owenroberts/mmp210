/** [p5.sound]  Version: 0.3.12 - 2020-05-16 */ 
 /**
    ...
    if (typeof paths === 'string') {
      ...
      if (['mp3', 'wav', 'ogg', 'm4a', 'aac'].indexOf(extTest) > -1) {
        if (!p5.prototype.isFileSupported(extTest)) {
          ...
          for (var _i = 0; _i < p5sound.extensions.length; _i++) {
            var _extension = p5sound.extensions[_i];
          ...
          for (var _i3 = 0; _i3 < p5sound.extensions.length; _i3++) {
            var _extension2 = p5sound.extensions[_i3];
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  var CustomError = __webpack_require__(12);
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  var p5sound = __webpack_require__(1); // generate noise buffers
